...
class MaplogController extends Controller
{
    ...
    public function getData($requestData) {
        ...
        if(!empty($requestData['paginator_maps'])){
            switch ($requestData['paginator_maps']) {
                case 1:
                    Session::put("paginator_maps",1);
                    break;
                case 2:
                    Session::put("paginator_maps",2);
                    break;
                case 3:
                    Session::put("paginator_maps",3);
                    break;
                case 4:
                    Session::put("paginator_maps",4);
                    break;
            }
        }
        ...
        switch (Session::get("paginator_maps")) {
            case 1:
