...
class ChatfblogController extends Controller
{
    ...
    public function getData($requestData)
    {
        ...
        if(!empty($requestData['paginator_facebook'])){
            switch ($requestData['paginator_facebook']) {
                case 1:
                    Session::put("paginator_facebook",1);
                    break;
                case 2:
                    Session::put("paginator_facebook",2);
                    break;
                case 3:
                    Session::put("paginator_facebook",3);
                    break;
                case 4:
                    Session::put("paginator_facebook",4);
                    break;
            }
        }
        ...
        switch (Session::get("paginator_facebook")) {
            case 1:
    ...
    public function index(Request $request)
    {
        ...
        if (isset($request->submitbutton)) {
            $pdf = PDF::loadView('chatfblog/exportpdf', $this->data);
            return $pdf->stream('serial_codes.pdf');

//            return view('chatfblog/exportpdf' , $this->data);
