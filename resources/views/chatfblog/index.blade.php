...
<div class="row container">
    <form id="form1" action="{{action("Admin\ChatfblogController@index")}}" method="get" class="form-group">
        <div class="col-md-12" style="display: flex">
            ...
            <div class="col-md-6">
                <a class="btn btn-primary" href="{{route('second', ['chatfblog', 'download'])}}">{{trans('message.download')}}</a>
            </div>
        </div>
