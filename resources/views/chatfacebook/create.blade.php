...
@section('content')
<form class="outer-repeater needs-validation" id="create-menu" action="{{action('Admin\ChatFaceBookController@store')}}" novalidate  method="post">
    {{ csrf_field() }}
    <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('facebookid')}}" id="time" name="facebookid" class="form-control"  required/>
                                     <div class="invalid-feedback">Nhập tên Facebook</div>
                                </div>
