...
@section('content')
<form class="outer-repeater needs-validation" id="update-user" action="{{route("chatfacebook.update")}}" novalidate   method="post">
    {{ csrf_field() }}
    <!-- Start Content-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card" style="height: 100%" id="loader">
                    <div class="card-body">
                <input type="hidden" value="{{$editChatFaceBook->id}}" id="id" name="id">
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <label for="projectname">{{__("Facebook Title")}}<span class="red">*</span></label>
                                    <input type="text"  id="time" name="facebook_title" value="{{$editChatFaceBook->facebook_title}}" class="form-control" maxlength="50" required/>
                                    <div class="invalid-feedback">Nhập Title Facebook</div>
                                </div>
                                <div class="form-group">
                                    <label for="projectname">Facebook ID<span class="red">*</span></label>
                                    <input type="text" value="{{$editChatFaceBook->facebook_id}}" id="facebookid" name="facebookid" class="form-control" maxlength="150" required />
