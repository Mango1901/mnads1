...
@section('content')
<form  class="outer-repeater needs-validation" id="update-user" action="{{action('Admin\CallController@update')}}" novalidate  method="post">
    {{ csrf_field() }}
    <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{($data->name)}}" id="time" name="name" class="form-control" required />
                                    <div class="invalid-feedback">Nhập tên</div>
                                    <label for="projectname">{{trans('message.phone_call')}}<span class="red">*</span></label>
                                    <input type="text" value="{{($data->phone_number)}}" id="phone" name="phone" class="form-control" required />
                                    <div class="invalid-feedback">Nhập số điện thoại</div>
                                    <label for="projectname">{{trans('message.description_call')}}<span class="red">*</span></label>
