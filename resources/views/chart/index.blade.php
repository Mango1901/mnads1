...
<?php
    ...
    $selectdate = Session::get("selectdate");
            ...
            $("#submit_data").click(function () {
                ...
                $(document).ready(function () {
                    ...
                    $.ajax({ //Process the form using $.ajax()
                        ...
                        // url: 'http://localhost/api/chartlog', //Your form processing file URL
                        url: window.location.origin + '/api/chartlog',
                        data: {date1: date1, date2: date2, token: token, selectdate: selectdate}, //Forms name
                        dataType: 'json',
