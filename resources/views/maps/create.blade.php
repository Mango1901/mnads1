...
@section('content')
<form class="outer-repeater needs-validation" id="create-menu" action="{{route("maps.store")}}" novalidate  method="post">
    {{ csrf_field() }}
    <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="map"  name="map_title" class="form-control" required minlength="1" maxlength="50">
                                    <div class="invalid-feedback">Nhập tên bản đồ</div>
                                </div>
                                <div class="form-group">
                                    <label for="map">{{trans('message.map')}}<span class="red">*</span></label>
                                    <textarea rows="10" id="map"  name="map" class="form-control" minlength="1" required>{{old('map')}}</textarea>
